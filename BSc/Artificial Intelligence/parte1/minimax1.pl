...
minimax_decidir(Ei,Points1,Points2,Opf,TimeToStop) :-
    Atual is 0, 
	findall(Vc-[Op,Es,PointsNovos1,PointsNovos2], (oper(Ei,Points1,Points2,player1,PointsNovos1,PointsNovos2,Op,Es), minimax_valor(Es,Vc,1,Atual,TimeToStop,PointsNovos1,PointsNovos2)), L),
    escolhe_max(L,Opf).


minimax_valor(Ei,Val,_,Atual,TimeToStop,Points1,Points2) :- 
    ((Atual is TimeToStop);
    (terminal(Ei,Points1,Points2))),
	valorCheck(Ei,Atual,Points1,Points2,Val).


minimax_valor(Ei,Val,P,Atual,TimeToStop,Points1,Points2) :-
    Atual1 is Atual+1, 
    Atual1 =< TimeToStop,
	P1 is P+1, jogador(P1,J),
	findall(Val1, (oper(Ei,Points1,Points2,J,PointsNovos1,PointsNovos2,_,Es), minimax_valor(Es,Val1,P1,Atual1,TimeToStop,PointsNovos1,PointsNovos2)), V),
