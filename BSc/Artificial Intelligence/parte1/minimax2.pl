...
maxValuePlayer1(_,Max,Atual,Verifica) :- Atual > 6, Max is Verifica,!. %vasco
...
maxValuePlayer2(_,Max,Atual,Verifica) :- Atual > 12, Max is Verifica,!.	%vasco
...
valorCheck(_,Atual,_,Pontos2,Dif) :- 
	Pontos2 >= 25,
	Dif is -25 - Atual.						%chegaste ao 25 pts
...
valorCheck(Ei,Atual,Pontos1,Pontos2,Dif) :-
	...
	Pontos1 < 25,							%nao chegaste a estador terminal
	Pontos2 < 25, 
...
valorCheck(Ei,Atual,Pontos1,Pontos2,Dif) :-
	...
	((Diferenca > 0,							%estado terminal nao chegaste a 25
	Dif is 25-Atual);
	(Diferenca < 0,
	Dif is -25-Atual);
	(Diferenca is 0,
