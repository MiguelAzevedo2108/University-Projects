...
continuaJogadas(Ei,Pontos1,Pontos2,_) :- 
    terminal(Ei,Pontos1,Pontos2),
    valorCheck(Ei,0,Pontos1,Pontos2,Dif), 
	((Dif > 0,
...
alfabeta(Ei,Points1,Points2,Opf,TimeToStop) :-
	Atual1 is 0, 
	findall(Vc-Op-Es-PointsNovos1-PointsNovos2, (oper(Ei,Points1,Points2,player1,PointsNovos1,PointsNovos2,Op,Es,_), alfabeta_min(Es,Vc,1,-10000,10000,Atual1,TimeToStop,PointsNovos1,PointsNovos2)), L),
	escolhe_max(L,Opf).
